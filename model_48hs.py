# -*- coding: utf-8 -*-
"""Dor Endo Everdan_48hs

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Jel7kLVo2a27PiFnXg8JUTlqbrZy_qvm
...
colunas = ['Irrigation solution', 'Foraminal enlargement', 'Sex','Irrigant activation',
       'Age range','Postoperative pain 48 hours (dichotomous)']

df = df.loc[:, colunas]

coluna_grupo = df.pop('Postoperative pain 48 hours (dichotomous)')
df.insert(0, 'Postoperative pain 48 hours (dichotomous)', coluna_grupo)
...
X = df.drop('Postoperative pain 48 hours (dichotomous)', axis=1)
features = X.columns
