# -*- coding: utf-8 -*-
"""Dor Endo Everdan_24hs

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ccz1KIkeGT3TPmbhUDU3B0Xg7Y4cuRES
...
colunas = ['Irrigation solution', 'Foraminal enlargement', 'Sex','Irrigant activation',
       'Age range','Postoperative pain 24 hours (dichotomous)']

df = df.loc[:, colunas]

coluna_grupo = df.pop('Postoperative pain 24 hours (dichotomous)')
df.insert(0, 'Postoperative pain 24 hours (dichotomous)', coluna_grupo)
...
X = df.drop('Postoperative pain 24 hours (dichotomous)', axis=1)
features = X.columns
